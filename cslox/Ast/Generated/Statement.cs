// Generated by cslox/Ast/generate.py at 12.08.2025 10:20 GMT+3
...
public abstract class Statement 
{
    ...
    public const int InheritorsAmount = 4;
...
public class Var(string name, Expression? initializer) : Statement
{
    ...
    {
        var sb = new StringBuilder();
        sb.Append(new string(' ', indent * 2)).Append("Var");
        sb.Append($" ({Name})");
        sb.Append('\n');
